    ...
    return(
      <div style={{maxWidth:520,margin:"0 auto",padding:20,fontFamily:"'Barlow',sans-serif",background:"#f5f0e8",minHeight:"100vh"}}>
        <div style={{background:"#0d0d0d",padding:"22px 24px",borderRadius:"6px 6px 0 0",display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          ...
          <button onClick={printShared} style={{background:"#e8a020",border:"none",borderRadius:4,padding:"8px 14px",fontFamily:"'Barlow Condensed',sans-serif",fontSize:13,fontWeight:700,letterSpacing:1,textTransform:"uppercase",cursor:"pointer",color:"#0d0d0d"}}>🖨 Save PDF</button>
        </div>
